...
DATA_PATH = _config.get('data_path', 'data/housing.csv')
MODEL_OUTPUT_PATH = _config.get('model_output_path', 'models')
...
CV_FOLDS = _config.get('cv_folds', 5)
RANDOM_SEARCH_ITERATIONS = _config.get('random_search_iterations', 5)
